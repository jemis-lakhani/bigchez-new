...
const JournalCard = ({ data }) => {
  return (
    <div className="group relative z-10 flex flex-col gap-5 rounded-3xl border-[1px] border-[#E7E5EA] p-4 pb-12 lg:p-4 lg:!pb-8 2xl:p-5 2xl:pb-10">
      ...
      <div className="relative rounded-2xl border-[2px] border-white">
        ...
        <div className="absolute bottom-0 left-1/2 z-10 -translate-x-1/2 translate-y-1/2 rounded-full bg-white p-px font-semibold">
          ...
          <div className="relative z-10 rounded-full bg-[linear-gradient(96.26deg,#0993AB_0%,#09748D_50%)] px-4 py-2 text-xs text-white uppercase transition-all duration-300 ease-in-out group-hover:!bg-[linear-gradient(0deg,#fff_0%,#fff_100%)] group-hover:text-[var(--primary)] xl:px-3 xl:text-[9px] 2xl:px-4 2xl:text-xs">
            {data?.badgeTitle}
          </div>
        </div>
      </div>
